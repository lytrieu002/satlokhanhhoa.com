...
<section id="sidebar" class="">
		...
		<div class="nav nav-sidebar container" id="tab1C" data-nav-type="accordion">
			...
			<li class="nav-item nav-item-submenu  active-ca">
				...
				<ul class="nav nav-group-sub" data-submenu-title="Các lớp dữ liệu">
					...
					<li class="nav-item">
						<label class="switch">
							<input type="checkbox"  id="chkBanDoSatLo" checked="checked"  onclick="setLayerVisible(this.id);"/>
							<span class="slider round"></span>
						</label>
						<span class="triger-pi">Bản đồ sạt lở</span>
					</li>
					<li class="nav-item">
						<label class="switch">
					...
					<li class="nav-item">
						...
						<span class="triger-pi">Đường bộ</span>
					</li>
			...
			<p style="padding:0 10px;">Cấp độ rủi ro</p>
			<table style="width:100%;padding:0 10px;">
				<tr>
					<td style="width:70px">
						<svg width="70px" height="20px">
							<rect width="100%" height="100%" style="fill:#fe0000;stroke-width:1;stroke:rgb(0,0,0)" />
					</svg>
				</td>
					<td>Cấp 4</td>
				</tr>
				<tr>
					<td style="width:70px">
						<svg width="70px" height="20px">
							<rect width="100%" height="100%" style="fill:#f79647;stroke-width:1;stroke:rgb(0,0,0)" />
					</svg>
				</td>
					<td>Cấp 3</td>
				</tr>
				<tr>
					<td style="width:70px">
						<svg width="70px" height="20px">
							<rect width="100%" height="100%" style="fill:#ffff00;stroke-width:1;stroke:rgb(0,0,0)" />
					</svg>
				</td>
					<td>Cấp 2</td>
				</tr>
				<tr>
					<td style="width:70px">
						<svg width="70px" height="20px">
							<rect width="100%" height="100%" style="fill:#92d14f;stroke-width:1;stroke:rgb(0,0,0)" />
					</svg>
				</td>
					<td>Cấp 1</td>
				</tr>
				<tr>
					<td style="width:70px">
						<svg width="70px" height="20px">
							<rect width="100%" height="100%" style="fill:#ffffff;stroke-width:1;stroke:rgb(0,0,0)" />
					</svg>
				</td>
					<td>Cấp 0</td>
				</tr>
	...
	<div id="popupX" class="ol-popupX">
        <a href="#" id="popup-closerX" class="ol-popup-closerX"></a>
        <div id="popup-contentX">
            <div id="popup-nameX"></div>
            <div id="popup-attributesX">
				<table class="data-table" id = "attribute_table">
